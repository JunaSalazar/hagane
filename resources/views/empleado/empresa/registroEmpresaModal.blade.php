          ...
          <div class="modal-body">
            <form method="post" action="/empresa/store">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="razon_social" minlength="1" maxlength="50" required>
              </div>

              <div class="form-group">
                <label for="recipient-name" class="form-control-label">RFC</label>
                <input type="text" class="form-control" name="rfc" minlength="1" maxlength="20" required>
              </div>
